...
import br.com.fiap.listener.FotoListener;
...
public class FotoListenerTest {

  @InjectMocks
  FotoListener fotoListener;
  ...
  @Test
  void dadoMessageValida_quandoSalvarFotoBaixaQualidade_entaoSucesso() throws Exception {
